...
Start with CLAUDE.md, then docs/design-brief.md.

## First session in VS Code + Claude Code
Open this folder, open the Claude Code panel, and start with:

1. "Read CLAUDE.md, docs/design-brief.md and adr/. Summarize the architecture
...
Then work the Linear project from docs/analysis-plan.md, one issue per branch.

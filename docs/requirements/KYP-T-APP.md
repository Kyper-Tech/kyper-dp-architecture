...
| REQ-KYP-T-APP-02 | The app runtime MUST run only signed, promoted artifacts; admission verifies before start. | ADR-0004 |
| REQ-KYP-T-APP-03 | Durable application state MUST live in the operational database (data layer), never in the runtime. | — |
| REQ-KYP-T-APP-04 | Tenant alerting MUST own escalation and suppression state, including acks synced up from edge replicas. | ADR-0010 |

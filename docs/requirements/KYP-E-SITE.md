...
|---|---|---|
| REQ-KYP-E-SITE-01 | The update agent MUST apply only signed bundles pulled through the sync layer; no other update path exists. | [ADR-0001](../../adr/0001-plane-structure.md), [ADR-0003](../../adr/0003-generic-sync-layer.md) |

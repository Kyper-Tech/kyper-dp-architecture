...
| REQ-KYP-E-RT-05 | Site inference MUST add to tenant serving, never replace it: a tenant without any site is fully functional, and both runtimes consume the same promoted models in per-target variants. | ADR-0004 |

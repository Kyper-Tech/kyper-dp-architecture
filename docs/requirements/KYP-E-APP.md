...
| REQ-KYP-E-APP-03 | Local API access MUST use device/site identities; no tenant-plane credentials cached at edge. | [ADR-0001](../../adr/0001-three-planes-pull-only.md) |

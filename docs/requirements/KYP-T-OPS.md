...
| REQ-KYP-T-OPS-04 | Observability MUST cover every component; logs ship outbound via the log shipper (pull-only rules hold). | [ADR-0001](../../adr/0001-three-planes-pull-only.md) |

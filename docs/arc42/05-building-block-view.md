...
Areas grouped by lifecycle: the environment container is instantiated per
environment ([ADR-0005](../../adr/0005-two-environments.md)); the data layer
is shared and zoned ([ADR-0006](../../adr/0006-shared-zoned-data-layer.md));

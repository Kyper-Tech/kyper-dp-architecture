...
| Q-02 | KYP-C | Control-plane compromise | No access into any customer environment or data ([ADR-0001](../../adr/0001-three-planes-pull-only.md)) | credentials reachable from control plane into tenants: zero |
